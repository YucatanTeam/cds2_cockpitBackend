            ...
            <div class="uk-width-medium-1-4">
               <div class="uk-panel uk-panel-box uk-panel-card">
                   ...
                   <div class="uk-margin">
                       ...
                       <input aria-label="<?php echo $app("i18n")->get('Name'); ?>" class="uk-width-1-1 uk-form-large" type="text" ref="name" bind="collection.name" pattern="[a-zA-Z0-9_]+" required>
                   ...
                   <div class="uk-margin">
                       ...
                       <input aria-label="<?php echo $app("i18n")->get('Label'); ?>" class="uk-width-1-1 uk-form-large" type="text" ref="label" bind="collection.label">
                   </div>

                   <div class="uk-margin">
                       <label class="uk-text-small"><?php echo $app("i18n")->get('Group'); ?></label>
                       <input aria-label="<?php echo $app("i18n")->get('Group'); ?>" class="uk-width-1-1 uk-form-large" type="text" ref="group" bind="collection.group">
                   </div>
                   ...
                   <div class="uk-margin">
                       ...
                       <textarea aria-label="<?php echo $app("i18n")->get('Description'); ?>" class="uk-width-1-1 uk-form-large" name="description" bind="collection.description" bind-event="input" rows="5"></textarea>
                   </div>
                    ...
                    <?php $app->trigger('collections.settings.aside'); ?>
