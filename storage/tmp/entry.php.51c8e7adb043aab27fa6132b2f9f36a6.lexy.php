...
<script>
    window.__collectionEntry = <?php echo  json_encode($entry) ; ?>;
</script>
    ...
    <div class="header-sub-panel">
        ...
        <div class="uk-container uk-container-center">
            ...
            <div class="uk-flex uk-flex-middle uk-text-bold uk-h3">
                ...
                <a class="uk-margin-left" onclick="{showPreview}" if="{ collection.contentpreview && collection.contentpreview.enabled }" title="<?php echo $app("i18n")->get('Preview'); ?>"><i class="uk-icon-button uk-icon-eye"></i></a>
            </div>
        </div>
