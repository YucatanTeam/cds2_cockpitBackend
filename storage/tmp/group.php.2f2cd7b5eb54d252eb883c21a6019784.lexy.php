<div>
    <ul class="uk-breadcrumb">
        <?php if ($app->module("cockpit")->hasaccess('cockpit', 'groups')) { ?>
        <li><a href="<?php $app->route('/settings'); ?>"><?php echo $app("i18n")->get('Settings'); ?></a></li>
        <li><a href="<?php $app->route('/groups'); ?>"><?php echo $app("i18n")->get('Groups'); ?></a></li>
        <?php } ?>
        <li class="uk-active"><span><?php echo $app("i18n")->get('Group'); ?></span></li>
    </ul>
</div>
...
<div class="uk-grid uk-margin-top uk-invisible" data-uk-grid-margin riot-view>
                    ...
                    <form id="groups-form" class="uk-form" onsubmit="{ submit }">
                        <div>
                            <div class="uk-form-row">
                                <label class="uk-text-small"><?php echo $app("i18n")->get('Group Name'); ?></label>
                                <input class="uk-width-1-1 uk-form-large" type="text" placeholder="<?php echo $app("i18n")->get('Group Name'); ?>" bind="group.group" required>
                            </div>
                        </div>
                        <div class="_uk-grid-margin uk-margin-small-top">
                            ...
                            <div class="uk-width-1-1 uk-margin-top" ref="vars">
                                <?php if (isset($group['vars'])) { ?>
                                    <?php foreach ( $group['vars'] as $i => $set) { ?>
                                    <div class="uk-panel uk-panel-box uk-panel-card var-row uk-margin-small-bottom">
                                        <div class="uk-grid uk-grid-small">
                                            <div class="uk-flex-item-1 uk-flex">
                                                <input class="uk-width-1-4 uk-form-small" type="text" placeholder="key" value="<?php echo $set['key']; ?>"><!-- TODO JB: perhaps create autocomplete for valid keys (jquery ui style) -->
                                                <i class="uk-width-1-4 uk-text-center uk-icon-arrows-h"></i>
                                                <input class="uk-width-1-4 uk-form-small" type="text" placeholder="value" value="<?php echo $set['val']; ?>">
                                                <?php if (isset($set['info']) && !empty($set['info'])) { ?>
                                                    <span class="uk-icon-info group-addon-info-icon-mod" title="<?php echo $set['info']; ?>"></span>
                                                <?php } ?>
                                                <div class="uk-width-1-4 uk-text-right">
                                                    <i class="uk-icon-trash" style="cursor: pointer" onclick="$(this).parents('.var-row').remove()"></i>
                                                </div>
                        ...
                        <div class="_uk-grid-margin uk-margin-small-top" ref="bulkactions">
                            ...
                            <div class="uk-grid uk-margin-top">
                                <div class="uk-width-1-2 _uk-float-left uk-margin-small-top">
                                    <field-boolean id="toggle_alsoCreateUser" bind="alsoCreateUser" label="<?php echo $app("i18n")->get('Also create a User with the Groups name'); ?>" ></field-boolean>
                                </div>
                            ...
                            <div class="uk-grid-margin">
                                <div class="uk-form-row">
                                    <div class="uk-float-left">
                                        <field-boolean bind="alsoCreateCollection" label="<?php echo $app("i18n")->get('Also create a Collection for the fresh User'); ?>" disabled="{ !alsoCreateUser }" ></field-boolean>
                                    </div>
                                    <div class="uk-float-right">
                                        <select onchange="{ updateSelectedCollection }" ref="collections" disabled="{ !alsoCreateCollection }">
                                            <option value="-1"><?php echo $app("i18n")->get('Choose a Collection as Template'); ?></option>
                                            <option value="{c.name}" each="{c in collections}">{c.label} ({c.name})</option>
                                        </select>
                                        <?php echo $app("i18n")->get('with name'); ?>:
                        ...
                        <?php $app->trigger('cockpit.groups.editview'); ?>

                        <div class="uk-margin-large-top">
                            <button class="uk-button uk-button-large uk-button-primary uk-width-1-3 uk-margin-right"><?php echo $app("i18n")->get('Save'); ?></button>
                            <a href="<?php $app->route('/groups'); ?>"><?php echo $app("i18n")->get('Cancel'); ?></a>
                        </div>
    ...
    <div class="uk-width-medium-1-4 uk-form">
        ...
        <h3><?php echo $app("i18n")->get('Group Access'); ?></h3>

        <div class="uk-form-row">
            <strong class="uk-text-uppercase">Generic</strong>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.admin" label="<?php echo $app("i18n")->get('Admin'); ?>"></field-boolean>
            </div>
        </div>
        <div class="uk-form-row">
            <strong class="uk-text-uppercase">cockpit</strong>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.cockpit.backend" label="<?php echo $app("i18n")->get('Backend'); ?>"></field-boolean>
            </div>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.cockpit.accounts" label="<?php echo $app("i18n")->get('Accounts'); ?>"></field-boolean>
            </div>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.cockpit.groups" label="<?php echo $app("i18n")->get('Groups'); ?>"></field-boolean>
            </div>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.cockpit.finder" label="<?php echo $app("i18n")->get('Finder'); ?>"></field-boolean>
            </div>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.cockpit.settings" label="<?php echo $app("i18n")->get('Settings'); ?>"></field-boolean>
            </div>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.cockpit.rest" label="<?php echo $app("i18n")->get('RestAPI'); ?>"></field-boolean>
            </div>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.cockpit.webhooks" label="<?php echo $app("i18n")->get('Webhooks'); ?>"></field-boolean>
            </div>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.cockpit.info" label="<?php echo $app("i18n")->get('SysInfo'); ?>"></field-boolean>
            </div>
        </div>
        <div class="uk-form-row">
            <strong class="uk-text-uppercase">collections</strong>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.collections.create" label="<?php echo $app("i18n")->get('Create'); ?>"></field-boolean>
            </div>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.collections.delete" label="<?php echo $app("i18n")->get('Delete'); ?>"></field-boolean>
            </div>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.collections.manage" label="<?php echo $app("i18n")->get('Manage'); ?>"></field-boolean>
            </div>
        </div>
        <div class="uk-form-row">
            <strong class="uk-text-uppercase">singletons</strong>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.singletons.create" label="<?php echo $app("i18n")->get('Create'); ?>"></field-boolean>
            </div>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.singletons.delete" label="<?php echo $app("i18n")->get('Delete'); ?>"></field-boolean>
            </div>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.singletons.manage" label="<?php echo $app("i18n")->get('Manage'); ?>"></field-boolean>
            </div>
        </div>
        <div class="uk-form-row">
            <strong class="uk-text-uppercase">forms</strong>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.forms.create" label="<?php echo $app("i18n")->get('Create'); ?>"></field-boolean>
            </div>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.forms.delete" label="<?php echo $app("i18n")->get('Delete'); ?>"></field-boolean>
            </div>
            <div class="uk-margin-small-top">
                <field-boolean bind="group.forms.manage" label="<?php echo $app("i18n")->get('Manage'); ?>"></field-boolean>
            </div>
        </div>
   ...
   <script type="view/script">
       ...
       this.group = <?php echo  json_encode(@$group) ; ?>;
