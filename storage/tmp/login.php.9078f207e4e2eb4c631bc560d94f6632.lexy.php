    ...
    <div class="uk-position-relative login-container uk-animation-scale uk-container-vertical-center" role="main" riot-view>
        ...
        <form class="uk-form" method="post" action="<?php $app->route('/auth/check'); ?>" onsubmit="{ submit }">
            ...
            <div class="uk-panel-box uk-panel-space uk-panel-card uk-nbfc uk-text-center uk-animation-slide-bottom" if="{$user}">
                ...
                <h1 class="uk-h2 uk-text-bold uk-text-truncate"><?php echo $app("i18n")->get('Welcome back!'); ?></h1>
            ...
            <div id="login-dialog" class="login-dialog uk-panel-box uk-panel-space uk-nbfc" show="{!$user}">
                ...
                <div class="uk-form-row">
                    <input ref="user" class="uk-form-large uk-width-1-1" type="text" aria-label="<?php echo $app("i18n")->get('Username'); ?>" placeholder="<?php echo $app("i18n")->get('Username'); ?>" autofocus required>
                </div>

                <div class="uk-form-row">
                    <div class="uk-form-password uk-width-1-1">
                        <input ref="password" class="uk-form-large uk-width-1-1" type="password" aria-label="<?php echo $app("i18n")->get('Password'); ?>"placeholder="<?php echo $app("i18n")->get('Password'); ?>" required>
